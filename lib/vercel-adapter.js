const aliasEnvironmentVariables = () => {
  const aliases = {
    AWS_ACCESS_KEY_ID: ['MY_AWS_ACCESS_KEY_ID', 'ZENVIO_AWS_ACCESS_KEY'],
    AWS_SECRET_ACCESS_KEY: ['MY_AWS_SECRET_ACCESS_KEY', 'ZENVIO_AWS_SECRET_KEY'],
    AWS_REGION: ['MY_AWS_REGION', 'ZENVIO_AWS_REGION'],
    AWS_S3_BUCKET: ['MY_AWS_S3_BUCKET_NAME', 'ZENVIO_AWS_S3_BUCKET'],
